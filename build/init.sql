...
VALUES ('admin@pixivpresentation.net', '$2y$10$1ohq7F7XDTRZa7L9y6FYVui1Bq/8ncdFU0fWeS1ALLBo0z4C4u8qm');
...
-- Insert another user
INSERT INTO accounts (username, password)
VALUES ('abcdefg.ghj@gmail.com', '$2y$10$1ohq7F7XDTRZa7L9y6FYVui1Bq/8ncdFU0fWeS1ALLBo0z4C4u8qm');
...
INSERT INTO voice_tags (tag_name, tag_category)
values ('10代', '年代別タグ');
INSERT INTO voice_tags (tag_name, tag_category)
values ('20代', '年代別タグ');
INSERT INTO voice_tags (tag_name, tag_category)
