...
class NotificationService implements \submission\NotificationService
{
    ...
    private const MAIL_HOST = 'pixiv.presentation.com';
    private const MAIL_FROM = 'demo@pixivpresentation.net';
    ...
    private const MAIL_FROM_NAME = 'presentation運営';
    ...
    public function notify(\submission\SignupRequest $signupRequest): void
    {
        ...
        try {
            ...
            $mail->addAddress('demo@pixivpresentation.net');
